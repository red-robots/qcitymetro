        ...
        <div id="content" role="main" class="wrapper">
            ...
            <div class="site-content">
                    ...
                    <div class="entry-content">
                        ...
                        <div class="business-details">
                            ...
                            <div class="col-1">
								...
								<?php } ?>
								<?php if ( $phone != '' ) { ?>
                                    <div class="fe-start"><strong>Phone:</strong> <a
                                                href="tel:<?php echo preg_replace( "/[^0-9]/", "", $phone ); ?>"><?php echo $phone; ?></a>
                                    </div>
								<?php } ?>
								...
								<?php } ?>
								<?php if ( $denomination != '' ) { ?>
                                    <div class="fe-cost"><strong>Denomination:</strong> <?php echo $denomination; ?>
                                    </div>
								<?php } ?>
								<?php if ( $pastor != '' ) { ?>
				...
				<?php } ?>
                    ...
                    <div class="other-details church">
                        <h3>Services</h3>
                        <ul>
					...
					if ( $index !== false && count( $posts ) > 1 ):?>
                        <nav class="nav-single">
							...
							<?php if ( count( $posts ) > 2 ): ?>
                                ...
                                <a href="<?php echo get_the_permalink( $posts[ $previous_index ] ); ?>"><span
                                            class="meta-nav">&larr;</span><?php echo $posts[ $previous_index ]->post_title; ?></a>
                                </span>
							<?php endif; ?>
