...
<?php
	...
	'tax_query' => array(
		array(
			'taxonomy' => 'size', // your custom taxonomy
			'field' => 'slug',
    ...
    <div class="featured-event-content-details">
        ...
        <div class="featured-event-content">
            ...
            <?php if( $termsDenomination != '' ) { ?>
            	<div class="fe-start"><strong>Denomination:</strong> <?php echo $termsDenomination[0]->name; ?></div>
            <?php } ?>
            <?php if( $termsSize != '' ) { ?>
            	<div class="fe-start"><strong>Size:</strong> <?php echo $termsSize[0]->name; ?></div>
            <?php } ?>
            <?php if( $website != '' ) { ?>
